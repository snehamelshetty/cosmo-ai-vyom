  ...
  return (
    <section className="relative min-h-[110vh] flex items-center justify-center overflow-hidden">
      <motion.div className="absolute inset-0" style={{ y: bgY }}>
        <motion.img src={milkywayBg} alt="" className="w-full h-[120%] object-cover"
      ...
      <motion.img src={planetEarth} alt="" className="absolute bottom-[10%] left-[5%] w-40 md:w-64 opacity-15 blur-[1px]"
        style={{ y: planetY }} animate={{ rotate: [0, 360] }} transition={{ duration: 150, repeat: Infinity, ease: "linear" }} />

      <motion.img src={astronautFloat} alt="" className="absolute top-[15%] right-[3%] w-28 md:w-44 opacity-25"
        style={{ y: astroY }} animate={{ y: [0, -20, 0], rotate: [0, 3, -2, 0] }}
